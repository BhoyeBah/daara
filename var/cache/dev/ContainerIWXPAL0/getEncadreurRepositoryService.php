 ...
 */
class getEncadreurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EncadreurRepository' shared autowired service.
     *
     * @return \App\Repository\EncadreurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EncadreurRepository.php';

        return $container->privates['App\\Repository\\EncadreurRepository'] = new \App\Repository\EncadreurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
