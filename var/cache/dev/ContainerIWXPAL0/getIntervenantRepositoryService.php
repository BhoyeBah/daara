 ...
 */
class getIntervenantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IntervenantRepository' shared autowired service.
     *
     * @return \App\Repository\IntervenantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IntervenantRepository.php';

        return $container->privates['App\\Repository\\IntervenantRepository'] = new \App\Repository\IntervenantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
