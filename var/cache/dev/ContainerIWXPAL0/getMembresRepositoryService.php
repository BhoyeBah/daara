 ...
 */
class getMembresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MembresRepository' shared autowired service.
     *
     * @return \App\Repository\MembresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MembresRepository.php';

        return $container->privates['App\\Repository\\MembresRepository'] = new \App\Repository\MembresRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
