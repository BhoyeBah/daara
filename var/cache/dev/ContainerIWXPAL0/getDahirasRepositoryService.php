 ...
 */
class getDahirasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DahirasRepository' shared autowired service.
     *
     * @return \App\Repository\DahirasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DahirasRepository.php';

        return $container->privates['App\\Repository\\DahirasRepository'] = new \App\Repository\DahirasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
