 ...
 */
class getSpecialitesRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SpecialitesRepository.php';

        return $container->privates['App\\Repository\\SpecialitesRepository'] = new \App\Repository\SpecialitesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
