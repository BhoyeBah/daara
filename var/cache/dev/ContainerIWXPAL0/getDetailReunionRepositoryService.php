 ...
 */
class getDetailReunionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailReunionRepository' shared autowired service.
     *
     * @return \App\Repository\DetailReunionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailReunionRepository.php';

        return $container->privates['App\\Repository\\DetailReunionRepository'] = new \App\Repository\DetailReunionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
