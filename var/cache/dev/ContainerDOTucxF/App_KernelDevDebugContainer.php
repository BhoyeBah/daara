...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\DahirasController' => 'getDahirasControllerService',
            'App\\Controller\\EncadreurController' => 'getEncadreurControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\MembresController' => 'getMembresControllerService',
            ...
            'App\\Controller\\ReunionController' => 'getReunionControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\SpecialitesController' => 'getSpecialitesControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'StatusListener.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('E1IfC5FhhN', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nfvEeCn5+D', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GWFpFgpr5S', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('znoD9OTCot', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventListener\\StatusListener')] fn () => ($container->privates['App\\EventListener\\StatusListener'] ?? self::getStatusListenerService($container)), 'onKernelRequest'], 0);
        $instance->addListener('security.interactive_login', [#[\Closure(name: 'App\\EventListener\\StatusListener')] fn () => ($container->privates['App\\EventListener\\StatusListener'] ?? self::getStatusListenerService($container)), 'onSecurityInteractiveLogin'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\DahirasController', 'App\\Controller\\EncadreurController', 'App\\Controller\\HomeController', 'App\\Controller\\MembresController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'App\\Controller\\ReunionController', 'App\\Controller\\SecurityController', 'App\\Controller\\SpecialitesController', 'App\\Controller\\ThemesController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventListener\StatusListener' shared autowired service.
     *
     * @return \App\EventListener\StatusListener
     */
    protected static function getStatusListenerService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->privates['App\\EventListener\\StatusListener'])) {
            return $container->privates['App\\EventListener\\StatusListener'];
        }

        return $container->privates['App\\EventListener\\StatusListener'] = new \App\EventListener\StatusListener($a, ($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0XY9mbH2m5', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('shMAY-wg3b', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('AUj-gtJZ5K', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DVd5c7adar', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iFtvLnz9Ls', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('khqGn1w3Ri', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\DahirasRepository' => ['privates', 'App\\Repository\\DahirasRepository', 'getDahirasRepositoryService', true],
            'App\\Repository\\DetailReunionRepository' => ['privates', 'App\\Repository\\DetailReunionRepository', 'getDetailReunionRepositoryService', true],
            'App\\Repository\\EncadreurRepository' => ['privates', 'App\\Repository\\EncadreurRepository', 'getEncadreurRepositoryService', true],
            'App\\Repository\\IntervenantRepository' => ['privates', 'App\\Repository\\IntervenantRepository', 'getIntervenantRepositoryService', true],
            'App\\Repository\\MembresRepository' => ['privates', 'App\\Repository\\MembresRepository', 'getMembresRepositoryService', true],
            ...
            'App\\Repository\\SpecialitesRepository' => ['privates', 'App\\Repository\\SpecialitesRepository', 'getSpecialitesRepositoryService', true],
            'App\\Repository\\ThemesRepository' => ['privates', 'App\\Repository\\ThemesRepository', 'getThemesRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\DahirasRepository' => '?',
            'App\\Repository\\DetailReunionRepository' => '?',
            'App\\Repository\\EncadreurRepository' => '?',
            'App\\Repository\\IntervenantRepository' => '?',
            'App\\Repository\\MembresRepository' => '?',
