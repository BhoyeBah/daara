...
/* user/new.html.twig */
class __TwigTemplate_0793a54dafb3ae6e9a445a919f889487 extends Template
{
...
\t\t\t\t\t\t<li class=\"breadcrumb-item active\" aria-current=\"page\">Formulaire de création d'un utilisateur</li>
\t\t\t\t\t</ol>
\t\t\t\t</nav>
\t\t\t</div>
...
\t<div class=\"pd-20 card-box mb-30\">
    <div class=\"clearfix\">
        <div class=\"pull-left\">
            <h4 class=\"text-success h4\">Créer un nouvel utilisateur</h4>
...
\t\t\t</div>
\t\t    <div class=\"col-md-6 col-sm-12 text-right\">
\t\t\t\t\t<a class=\"btn btn-success\" href=\"{{ path('app_users_index') }}\">
\t\t\t\t\t\tListe des utilisateurs
\t\t\t\t\t</a>
\t\t\t</div>
\t\t</div>
...
{% endblock %}
", "user/new.html.twig", "C:\\xampp\\htdocs\\mydaara\\templates\\user\\new.html.twig");
    }
}
